...
import usercode.RpPbAnalysis.RpPbTrackingAnalyzer_cfi

trkAna_quality = usercode.RpPbAnalysis.RpPbTrackingAnalyzer_cfi.trkAna.clone(
        applyCuts = cms.bool(True)
)

trkAna_pixel = usercode.RpPbAnalysis.RpPbTrackingAnalyzer_cfi.trkAna.clone(
   trackSrc = cms.InputTag("pixelTracks")
)

trkAna_noBS = usercode.RpPbAnalysis.RpPbTrackingAnalyzer_cfi.trkAna.clone(
   vertexSrc = cms.InputTag("offlinePrimaryVertices")
)


trkAna_HIN12017 = usercode.RpPbAnalysis.RpPbTrackingAnalyzer_cfi.trkAna.clone(
   applyCuts = cms.bool(True),
