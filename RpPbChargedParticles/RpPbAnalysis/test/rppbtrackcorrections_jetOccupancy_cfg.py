...
process.load('usercode.RpPbAnalysis.RpPbTrackingCorrections_cfi')
...
process.trkCorr_akPu3PF_dR03 = process.pPbTrkCorr.clone(
    jetSrc = cms.InputTag('akPu3PFpatJets'),
    occByCentrality = cms.bool(False),
    occByJetEt = cms.bool(True),
    jetRadius = cms.double(0.3),
    occBins = cms.vdouble( 0.,40.,80.,120.,160.,200.,250.,500.,1000.),
)

process.trkCorr_akPu3PF_dR01 = process.pPbTrkCorr.clone(
    jetSrc = cms.InputTag('akPu3PFpatJets'),
    occByCentrality = cms.bool(False),
    occByJetEt = cms.bool(True),
    jetRadius = cms.double(0.1),
    occBins = cms.vdouble( 0.,40.,80.,120.,160.,200.,250.,500.,1000.),
)

process.trkCorr_akPu3PF_dR05 = process.pPbTrkCorr.clone(
    jetSrc = cms.InputTag('akPu3PFpatJets'),
    occByCentrality = cms.bool(False),
    occByJetEt = cms.bool(True),
...
process.trkCorr_akPu3PF_dR08 = process.pPbTrkCorr.clone(
    jetSrc = cms.InputTag('akPu3PFpatJets'),
    occByCentrality = cms.bool(False),
    occByJetEt = cms.bool(True),
...
process.p = cms.Path( 
    ...
    process.trkCorr_akPu3PF_dR08 *
    process.trkCorr_akPu3PF_dR05 *
    process.trkCorr_akPu3PF_dR03 *
    process.trkCorr_akPu3PF_dR01 
)
