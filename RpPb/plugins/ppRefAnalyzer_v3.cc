...
class ppRefAnalyzer_v3 : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit ppRefAnalyzer_v3(const edm::ParameterSet&);
      ~ppRefAnalyzer_v3();
...
//
ppRefAnalyzer_v3::ppRefAnalyzer_v3(const edm::ParameterSet& iConfig)
...
ppRefAnalyzer_v3::~ppRefAnalyzer_v3()
{
...
// Fill event multiplicity only when its greater than zero
  ...
  vtxPerEvent->Fill(vertex->size());
	...
	std::sort( vsorted.begin(), vsorted.end(), ppRefAnalyzer_v3::vtxSort );
...
bool
ppRefAnalyzer_v3::vtxSort( const reco::Vertex &  a, const reco::Vertex & b )
{
	return 0 /*Change here*/;
}

void ppRefAnalyzer_v3::initHistos(const edm::Service<TFileService> & fs)
{
...
bool
ppRefAnalyzer_v3::passesTrackCuts(const reco::Track & track, const reco::Vertex & vertex){

return 1;/* Change here */
}
// ------------ method called once each job just before starting event loop  ------------
void 
ppRefAnalyzer_v3::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
ppRefAnalyzer_v3::endJob() 
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
ppRefAnalyzer_v3::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(ppRefAnalyzer_v3);
