...
//   cout << EventNumber_t << endl;
   ...
   { 
	...
	setPtLimits = trackPt > pTMin_ && trackPt < pTMax_ ;
	setEtaLimits = trackEta > etaMin_ && trackEta < etaMax_ ;

	// separating the positive and negative charged particle
	// spectra
	if ( setPtLimits && setEtaLimits ){
			cout << trackPt << ", ";
