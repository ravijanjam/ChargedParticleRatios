...
void ChargedParticles_v6( char *inputRootFile1, char *inputRootFile2 ){

	TCanvas *c1 = new TCanvas ("c1", "Charged Particle Ratios Invariant Yield", 1000, 700);
	c1->Divide(3, 2);

	TCanvas *c2 = new TCanvas ("c2", "Charged Particle Ratios Invariant Yield", 1000, 700);
	c2->Divide(3, 2);

	TCanvas *c3 = new TCanvas ("c3", "The ratios of pt from pPb and pp", 1000, 700);
	...
	/* ===================================================================*/
	// pT Spectra
	TFile *inputFile1 = new TFile(inputRootFile1, "r");
