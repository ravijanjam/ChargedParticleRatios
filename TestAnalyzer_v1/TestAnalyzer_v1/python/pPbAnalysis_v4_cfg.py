...
process.TFileService = cms.Service("TFileService", 
	fileName = cms.string("pPbMinBias1.root") 
	)
...
process.source = cms.Source("PoolSource",
	...
	'/store/hidata/HIRun2013/PAHighPt/AOD/PromptReco-v1/000/209/868/00000/88E1150C-8060-E211-97B5-003048D3C980.root'
    )
)

'''
mylist = FileUtils.loadListFromFile ('pPb_MinimumBias1.txt')
for fname in mylist:
